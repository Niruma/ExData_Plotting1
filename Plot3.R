...
points(newdata1$Datetime, newdata1$Sub_metering_2, type="l",  col="red",xlab = "", ylab = "Energy sub metering")
points(newdata1$Datetime, newdata1$Sub_metering_3, type="l",  col="blue", xlab = "", ylab = "Energy sub metering")
